  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm uppercase tracking-wide text-garnet-600">Team profile</p>
      ...
      <section className="rounded-2xl border border-garnet-100 bg-white/85 p-5 shadow">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-ink">Player rating leaders</h2>
          <span className="text-xs text-ash">Base cup weights across all games.</span>
        </div>
          ...
          {topImpacts.map((row, idx) => (
            <div key={row.id} className="rounded-xl border border-garnet-100 bg-parchment/70 px-4 py-3 text-sm">
              ...
              <p className="text-garnet-600">
                {row.weightedPoints.toFixed(2)} rating · {row.makes} cups ·{' '}
