...
import { sortPlayerGamesBySeasonAndWeek } from '@/lib/player-game-order';
import type { SeasonLike } from '@/lib/season';
...
export async function PlayerDashboard({
  ...
  const gameRows: PlayerGameRow[] = orderedGames.map((game) => {
